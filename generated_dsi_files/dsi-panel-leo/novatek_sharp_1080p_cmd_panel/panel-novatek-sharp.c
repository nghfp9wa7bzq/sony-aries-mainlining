...
static int novatek_sharp_on(struct novatek_sharp *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x5c, 0x83);
	mipi_dsi_dcs_write_seq(dsi, 0x5d, 0x83);
	mipi_dsi_dcs_write_seq(dsi, 0x5e, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x5f, 0x03);
	mipi_dsi_dcs_write_seq(dsi, 0x6d, 0x55);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x10);
	mipi_dsi_dcs_write_seq(dsi, 0xff, 0x24);
	mipi_dsi_dcs_write_seq(dsi, 0xfb, 0x01);
...
MODULE_DESCRIPTION("DRM driver for sharp novatek 1080p cmd");
MODULE_LICENSE("GPL");
