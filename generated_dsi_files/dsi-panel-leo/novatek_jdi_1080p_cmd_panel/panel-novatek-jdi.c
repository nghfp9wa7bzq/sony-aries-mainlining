...
static int novatek_jdi_on(struct novatek_jdi *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0x44, 0x03);
	mipi_dsi_generic_write_seq(dsi, 0xff, 0xe0);
	mipi_dsi_generic_write_seq(dsi, 0xb5, 0x86);
	mipi_dsi_generic_write_seq(dsi, 0xb6, 0x77);
	mipi_dsi_generic_write_seq(dsi, 0xb8, 0xad);
	mipi_dsi_generic_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xff, 0x20);
	mipi_dsi_generic_write_seq(dsi, 0x10, 0x04);
	mipi_dsi_generic_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xff, 0x24);
	mipi_dsi_generic_write_seq(dsi, 0x92, 0x95);
	mipi_dsi_generic_write_seq(dsi, 0xfb, 0x01);
	mipi_dsi_generic_write_seq(dsi, 0xc4, 0x20);
	mipi_dsi_generic_write_seq(dsi, 0xff, 0x10);
	mipi_dsi_generic_write_seq(dsi, 0xfb, 0x01);
...
MODULE_DESCRIPTION("DRM driver for jdi novatek 1080p cmd");
MODULE_LICENSE("GPL");
